                            ...
                            <table className="min-w-full divide-y divide-gray-200  ">
                                ...
                                <tbody className="bg-[#F6F4EB] divide-y divide-gray-200 text-center ">
                                    {categoryIncome.map(res => {
                                        return <BudgetDetailIncomeItem categoryId={res.id} travelId={travelId} categoryName={res.title} />
                                    })
                                    }
                            ...
                            <table className="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody className="bg-[#F6F4EB] divide-y divide-gray-200 text-black text-center">
                                    {categoryExpense.map(res => {
                                        return <BudgetDetailExpenseItem travelId={travelId} categoryId={res.id} categoryName={res.title} />
                                    })
                                    }
                                </tbody>
                            </table>
